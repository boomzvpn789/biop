...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; bg-color:red">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/home"><i class="fa fa-dashboard fa-lg fa-fw"></i> SPEED VPN</a>
        </div>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="sidebar-search">
						...
						<li><a href="<?= base_url('panel/'.$_SESSION['username'].'/setting')?>"><i class="fa fa-key"></i> เปลียนรหัสผ่าน</a></li>
                        ...
                        <li>
                              <a href="<?= base_url('panel/reseller/cek_account/'.$_SESSION['username']) ?>"><i class="fa fa-users"></i> ตรวจสอบบันชี</a>
                        </li>
                        <li>
							<a href="<?= base_url('panel/'.$_SESSION['username'].'/setting')?>"><i class="fa fa-gear fa-fw"></i> เปลียนรหัสผ่าน</a>
                        </li>
						<li>
							<a href="https://www.facebook.com/groups/731537630346698"><i class="fa fa-facebook fa-fw"></i> กลุ่ม Facebook</a>
                        </li>
                        <?php endif; ?>
					  <li>
