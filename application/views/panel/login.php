                    ...
                    <div class="panel-body">
                        <?= form_open() ?>
                            <fieldset>
                                ...
                                <input type="submit" class="btn btn-success btn-sm hapus pull-left" value="เข้าสู่ระบบ"></input>
                                <a href="<?= base_url('panel/register') ?>" class="btn btn-danger btn-sm hapus pull-right">สมัครบัญชี</a>
                            </fieldset>
                        </form>
                    </div>
