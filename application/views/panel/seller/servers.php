            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <b><?= $row['ServerName']?></b> <?php if ($row['Status']) { echo '';} else {echo "(บัญชีเต็มแล้ว)";}?>
                    </div>
                    <table class="table">
                        <tr>
                    ...
                    <div class="panel-footer text-left">
                        <a href="http://<?= $row['HostName']?>:81/ConfigPanel/Config.ovpn" class="btn btn-danger"><i class="fa fa-download fa-fw"></i> Ovpn</a>
