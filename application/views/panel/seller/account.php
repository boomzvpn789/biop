    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <p class="text-muted">
					รายละเอียด:<br>
					สำหรับพอร์ต ที่ใช้งานได้ (80, 3128, dan 8080)<br>
                   คำเตือน!!! 1 บันชีห้ามใช้งานเกิน 2เครื่องในเวลาเดียวกัน ถ้าฝ่าฝื้นกฎ ระบบจะลบบันชีของคุณโดยอัตโนมัต
                </p>
                <div class="hidden-print">
					   <a href="http://<?= $user['hostname']?>:81/ConfigPanel/Config.ovpn" class="btn btn-danger"><i class="fa fa-download fa-fw"></i> Ovpn</a>
